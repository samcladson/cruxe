...
function buildDailyManifest(): PuzzleSpec[] {
  ...
  // Daily Challenge: general, medium, 10×10
  // Explicitly uses category 'general' to match user preference.
  // Stored with isDailyChallenge: true — since it uses variant 1, it will
  // overwrite the regular general/medium/10x10 puzzle with the daily flag.
  specs.push({
    category: "general",
    difficulty: "medium",
    gridSize: 10,
